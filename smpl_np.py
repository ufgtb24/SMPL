...
# https://khanhha.github.io/posts/SMPL-model-introduction/#pose-blend-shapes
...
class SMPLModel():
    ...
    """
        ...
        # 2. how pose affect body shape in zero pose
        # posedirs 是 Pose 到 vertex 的映射，这里是计算 vertex 受 pose 的影响，是学习出的
        v_posed = v_shaped + self.posedirs.dot(lrotmin)
        
        # skinning: 3+4
        
        # 3. world transformation of each joint
        ...
        # 如果 R=T ，则 G=0 ，保证T-pose 的旋转矩阵为0。由相对于 x y z 坐标轴的旋转，变成相对于 T-pose
        G = G - self.pack(
            np.matmul(
                G,
        ...
        # 4. transformation of each vertex
...
if __name__ == '__main__':
    smpl = SMPLModel('./basicModel_f_lbs_10_207_0_v1.0.0.pkl')
    np.random.seed(9608)
